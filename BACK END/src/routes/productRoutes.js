...
router.get('/templates/images', productController.getProductTemplates);
router.get('/', productController.getProducts);
router.get('/:id', productController.getProductById);

// Farmer & Admin Inventory Endpoints
router.post('/upload-image', verifyToken, authorizeRoles('Farmer', 'Administrator'), productController.uploadProductImage);
